...
# ap.add_argument("-c", "--image", required=True,
#                 help="E:\cmc\aruco\main\kinect_ArUco marker\calibrationKinect")

# args = vars(ap.parse_args())

# image = cv2.imread(args["image"])

_img_pth = r"E:\datasets\deeptag_pytorch_dataset\deeptag_dataset\imgs_0106\000001.png"

image = cv2.imread(_img_pth)
